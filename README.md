...
- Render — 컬럼별 Render 산출(description, type_candidate, 오류위험 플래그, 표면형 후보, codedict)
- P-SQL — 컬럼별 빈도, 사용 역할, where 리터럴, 별칭, 조인 쌍, 공동참조
- 게이팅 — 빈도 + 구조위험 + 약한 충돌가점 점수, 우선순위 티어, 클러스터 끌어오기, must 놓침
